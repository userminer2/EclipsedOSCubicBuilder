...
alias update-repo="sudo apt update"
alias cleansys="sudo apt autoremove"
alias searchapp="sudo apt list"

#EclipsedOS version info
echo about EclipsedOS:
#echo "(warning)You are currently using a beta version of EclipsedOS."
#echo "(warning) The system might be unstable as a result"
echo "crrent version: EclipsedOS 1.2"
echo "To install apps use 'Install <program name>'."
echo "To remove apps use 'remove <program name>'."
echo "To remove unused programs/plugins/packages use 'cleansys'."
echo "to search for the availability of apps use 'searchapp *<program name>*'."
